/** sync with frontend/src/lib/collectConversationSources.js */
...
function collectConversationSources(messages, { excludeMessageId } = {}) {
  const seen = new Set();
  const out = [];
...
module.exports = { collectConversationSources };
