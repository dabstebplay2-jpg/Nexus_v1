...
const allowed: Record<Status, Status[]> = {
  ...
  ACTING: ["OBSERVING", "WAITING_PERMISSION", "WAITING_CONTEXT", "RECOVERING", "VERIFYING"],
  OBSERVING: ["ACTING", "VERIFYING", "RECOVERING", "UNDERSTANDING"],
  VERIFYING: ["WAITING_PERMISSION", "OBSERVING", "ACTING", "COMPLETED", "RECOVERING"],
  RECOVERING: ["UNDERSTANDING", "ACTING", "VERIFYING", "WAITING_PERMISSION", "WAITING_CONTEXT"],
  WAITING_PERMISSION: ["ACTING", "VERIFYING", "RECOVERING"],
  WAITING_CONTEXT: ["RECOVERING"],
